...
USER_MEMORIES_RELPATH = ".zerocode/memories.md"
PROJECT_MEMORIES_RELPATH = ".zerocode/memories.md"
...
class MemoryManager:
    ...
    def user_mem_dir(self) -> Path:
        """User-level memory directory (~/.zerocode/memory/).
    ...
    def project_mem_dir(self) -> Path:
        """Project-level memory directory (<project>/.zerocode/memory/).
