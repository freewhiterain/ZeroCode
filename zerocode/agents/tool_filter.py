...
def build_teammate_tools(
    ...
    from zerocode.tools.send_message import SendMessageTool
    from zerocode.tools.task_create import TaskCreateTool
    from zerocode.tools.task_get import TaskGetTool
    from zerocode.tools.task_list import TaskListTool
    from zerocode.tools.task_update import TaskUpdateTool
