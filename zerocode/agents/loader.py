...
PROJECT_AGENTS_DIR = ".zerocode/agents"
USER_AGENTS_DIR = "~/.zerocode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("zerocode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from zerocode.agents.parser import parse_frontmatter, _validate_agent_meta
