...
from zerocode.commands import (
    CommandContext,
    CommandRegistry,
    complete,
    parse_command,
)
from zerocode.commands.completion import CompletionPopup
from zerocode.commands.handlers import register_all_commands
from zerocode.config import MCPServerConfig, ProviderConfig
from zerocode.hooks import HookContext, HookEngine, load_hooks
from zerocode.conversation import ConversationManager, Message
from zerocode.mcp_client import MCPManager
from zerocode.memory import (
    MemoryManager,
    Session,
    SessionManager,
...
from zerocode.agents.notification import inject_task_notifications
from zerocode.commands.handlers.tasks import create_tasks_command
from zerocode.skills.executor import SkillExecutor
from zerocode.skills.loader import SkillLoader
from zerocode.commands.handlers.skill_register import register_skill_commands
from rich.text import Text as RichText
from textual.theme import Theme
from zerocode.cache import FileCache
from zerocode.tools import ToolRegistry, create_default_registry
from zerocode.tools.agent_tool import AgentTool
from zerocode.tools.ask_user import AskUserEvent, AskUserTool
from zerocode.tools.impl.tool_search import ToolSearchTool
from zerocode.tools.load_skill import LoadSkill
from zerocode.worktree.cleanup import start_stale_cleanup_task
from zerocode.worktree.manager import WorktreeManager
from zerocode.commands.handlers.worktree import create_worktree_command
from zerocode.teammate_tree import TeammateTree
...
class ZeroCodeApp(App):
    ...
    def on_mount(self) -> None:
        self.register_theme(_ZeroCode_THEME)
        self.theme = "ZeroCode"
        if len(self.providers) == 1:
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        from zerocode.filehistory import FileHistory
        ...
        from zerocode.tools.exit_plan_mode import ExitPlanModeTool
        ...
        from zerocode.tools.enter_worktree import EnterWorktreeTool
        from zerocode.tools.exit_worktree import ExitWorktreeTool
        ...
        from zerocode.commands.handlers.trace import create_trace_command
        ...
        from zerocode.tools.synthetic_output import SyntheticOutputTool
    ...
    async def _prefetch_relevant_memories(self, query: str) -> str:
        ...
        async def selector(system_prompt: str, user_message: str) -> str:
            from zerocode.tools.base import StreamEnd, TextDelta
    ...
    async def _show_plan_approval(self) -> None:
        from zerocode.plan_dialog import InlinePlanWidget
    ...
    def on_inline_plan_widget_responded(
        ...
        from zerocode.plan_dialog import InlinePlanWidget, PlanChoice
    ...
    async def _handle_askuser(self, event: AskUserEvent) -> None:
        from zerocode.askuser_dialog import InlineAskUserWidget
