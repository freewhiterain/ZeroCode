...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from zerocode.agents.fork import ForkError, build_forked_messages
        from zerocode.agents.parser import AgentDef
        from zerocode.agents.tool_filter import resolve_agent_tools
        from zerocode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from zerocode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from zerocode.agents.fork import ForkError, build_forked_messages
        from zerocode.agents.parser import AgentDef
        from zerocode.agents.tool_filter import build_teammate_tools
        from zerocode.agent import Agent as AgentClass
        from zerocode.conversation import ConversationManager
        from zerocode.permissions import (
            DangerousCommandDetector,
        ...
        from zerocode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from zerocode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from zerocode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from zerocode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from zerocode.client import create_client
        from zerocode.config import ProviderConfig
