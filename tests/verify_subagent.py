...
from zerocode.agents.fork import FORK_BOILERPLATE_TAG, ForkError, build_forked_messages
...
from zerocode.conversation import ConversationManager, ToolUseBlock
...
def verify_permission():
    print("\n== 8. DONT_ASK 权限模式 ==")
    from zerocode.permissions.modes import PermissionMode, mode_decide
...
def verify_agent_tool():
    ...
    from zerocode.tools.agent_tool import AgentTool, AgentToolParams
